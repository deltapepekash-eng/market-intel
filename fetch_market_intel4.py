...
# NSE-specific fallbacks — ET Markets works, so use it + distinct NSE-angle queries
NSE_RSS_FALLBACKS = [
    # ET Markets corporate alerts — same reliable source as BSE, tagged NSE
    "https://economictimes.indiatimes.com/markets/stocks/rssfeeds/2146842.cms",
    # Moneycontrol corporate news (distinct from ET Markets)
    ...
    "https://www.cnbctv18.com/commonfeeds/v1/eng/rss/market.xml",
    # NSE-specific: SEBI filings, insider trading, shareholding
...
def fetch_nse() -> List[Dict]:
    ...
    # Fallback: Try all NSE RSS sources and accumulate
